      ...
      if (data) {
        ...
        if (data.chat_history && Array.isArray(data.chat_history) && data.chat_history.length > 0) {
          ...
          const timelineEvents = sortedHistory.map((session: any) => {
            ...
            return {
              id: session.id,
              date: new Date(session.updatedAt).toLocaleDateString('en-US', { month: 'short', day: 'numeric' }),
              event: session.title === 'New Conversation' ? 'Consultation' : session.title,
              type: 'symptom',
        ...
        <main className="flex-1 px-4 py-8">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 mb-8">
              <div>
                ...
                <p className="text-slate-600 dark:text-slate-400">
                  Manage your health information and track your history
                </p>
              </div>
              <button
              ...
              {healthTimeline.length > 0 ? (
                ...
                <div className="bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 rounded-xl p-10 text-center flex flex-col items-center justify-center">
                  ...
                  <p className="text-slate-500 dark:text-slate-400 max-w-md mx-auto mb-6">
                    Your timeline will automatically populate based on the medical consultations and symptom checks you perform with the HealthChat AI.
                  </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
              <Link href="/chatbot" className="group p-6 bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 rounded-lg hover:border-blue-500 dark:hover:border-blue-500 hover:shadow-lg transition-all">
              ...
              <Link href="/profile" className="group p-6 bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 rounded-lg hover:border-green-500 dark:hover:border-green-500 hover:shadow-lg transition-all">
                <div className="flex items-start justify-between mb-4">
              ...
              <Link href="/settings" className="group p-6 bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 rounded-lg hover:border-purple-500 dark:hover:border-purple-500 hover:shadow-lg transition-all">
                <div className="flex items-start justify-between mb-4">
